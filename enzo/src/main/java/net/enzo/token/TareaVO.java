...
public class TareaVO implements Serializable{
	...
	/**
	 * Descripcion del responsable de la actividad.
	 */
	...
	public String toString() {
		return "TareaVO [idTarea=" + idTarea + ", numeroTarea=" + numeroTarea
				+ ", estado=" + estado + ", nombreTarea=" + nombreTarea
				+ ", usuarioCreador=" + usuarioCreador + ", prioridad="
				+ prioridad + ", urlTarea=" + urlTarea + ", fechaInicio="
				+ fechaInicio + ", fechaFinEjecucion=" + fechaFinEjecucion
				+ ", fechaInicioEjecucion=" + fechaInicioEjecucion
				+ ", fechaCompromiso=" + fechaCompromiso + ", rol=" + rol
